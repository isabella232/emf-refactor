...
<div id="maincontent">
	...
	<div id="midcolumn">
		...
		<h1>$pageTitle</h1>	
			...
			<img src="fig/appl_01_new.PNG" width="750" height="464" alt="Fig. a_1">	
			<p></p>
			...
			<img src="fig/appl_02.PNG" width="407" height="477" alt="Fig. a_2">
			<p></p>
			...
			<img src="fig/appl_03.PNG" width="684" height="474" alt="Fig. a_3">
			<p></p>
			...
			<img src="fig/appl_04.PNG" width="495" height="552" alt="Fig. a_4">
			<p></p>
			...
			<img src="fig/appl_05.PNG" width="503" height="140" alt="Fig. a_5">
			<p></p>
			...
			<img src="fig/appl_01.PNG" width="750" height="464" alt="Fig. a_1">	
			<p></p>
			...
			<img src="fig/appl_06.PNG" width="491" height="505" alt="Fig. a_6">	
			<p></p>
			...
			<img src="fig/appl_07.PNG" width="503" height="138" alt="Fig. a_7">
			<p></p>
			...
			<img src="fig/appl_08.PNG" width="492" height="631" alt="Fig. a_8">	
			<p></p>
			...
			<img src="fig/appl_09.PNG" width="477" height="159" alt="Fig. a_9">	
			<p></p>
			<p>Again, <b>EMF Refactor</b> does not apply refactoring <b>Move EAttribute</b> because of the violated precondition. The following figure shows the corresponding error message.</p>
			<img src="fig/appl_10.PNG" width="449" height="372" alt="Fig. a_10">	
			<p></p>
			...
			<img src="fig/appl_11.PNG" width="477" height="158" alt="Fig. a_11">	
			<p></p>
			<p>Again, <b>EMF Refactor</b> does not apply refactoring <b>Move EAttribute</b> because of the violated precondition. The following figure shows the corresponding error message.</p>
			<img src="fig/appl_12.PNG" width="449" height="372" alt="Fig. a_10">	
			<p></p>
			...
			<img src="fig/appl_13.PNG" width="493" height="599" alt="Fig. a_13">	
			<p></p>
			...
			<img src="fig/appl_14.PNG" width="477" height="157" alt="Fig. a_14">	
			<p></p>
			...
			<img src="fig/appl_15.PNG" width="477" height="501" alt="Fig. a_15">	
			<p></p>
			...
			<img src="fig/appl_16.PNG" width="405" height="480" alt="Fig. a_16">	
			<p></p>
			<p>Of course, <b>EMF Refactor</b> provides undo ...</p>
			<img src="fig/appl_17.PNG" width="254" height="292" alt="Fig. a_17">	
			<p></p>
